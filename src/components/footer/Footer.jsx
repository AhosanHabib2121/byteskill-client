...
const Footer = () => {
    return (
        <>
            <div className=" bg-[#1C1E2A] relative">
                <footer className="footer justify-center md:px-5 md:justify-normal lg:px-0 py-20  font-fontRoboto max-w-7xl md:mx-auto ">
                    <aside>
                        ...
                        <p className=" text-sm text-[#94A3B8]">
                            BYTESKILL Etiam interdum arcu metus, <br/> eget ultricies eros euismod ut.
                        </p>
